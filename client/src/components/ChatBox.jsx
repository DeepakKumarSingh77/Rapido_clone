...
const ChatBox = ({ rideId, userId, captainId, role, messages, setMessages, onClose }) => {
  ...
  useEffect(() => {
    ...
    socket.off("chatMessage"); // clear old listeners
    socket.on("chatMessage", handleMessage);

    return () => {
      socket.off("chatMessage", handleMessage);
    };
  }, [socket, rideId, setMessages]);
  ...
  const sendMessage = () => {
    ...
    // ✅ Show immediately in sender's chat
